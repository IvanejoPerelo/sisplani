                                ...
                                <tbody>
                                    {detailTable.map((value) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-4 font-medium text-gray-900  dark:text-white"> {value.dni}</td>
                                            <td className="px-4 py-4 font-medium text-gray-900  dark:text-white">
                                                {value.apellido_p} {value.apellido_m}, {value.nombres}
                                            </td>
                                            <td className="px-4 py-4">{value.cargo}</td>
                                            <td className={`${value.estado === "A" ? "text-blue-950 font-medium" : "text-gray-500"} px-4 py-4`}>{value.estado === "A" ? "Activo" : "Inactivo"}</td>
