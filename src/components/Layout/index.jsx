...
export default function Layout() {
  ...
  <div>
      <div>
      <nav className="fixed top-0 z-50 w-full bg-red-700 border-gray-200">
    ...
    <div>
      <aside
        id=""
        className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-red-700 border-r border-gray-200 sm:translate-x-0"
        aria-label="Sidebar"
      >
